...
RUN mkdir -p crates/domain/src crates/github/src/bin crates/state/src/bin \
...
RUN touch crates/domain/src/lib.rs crates/github/src/main.rs crates/github/src/bin/seed_export.rs crates/github/src/bin/queue.rs crates/state/src/lib.rs crates/state/src/bin/state.rs \
    && cargo build --release --locked -p review-radar-github \
    && cargo build --release --locked -p review-radar-state --bin review-radar-state
